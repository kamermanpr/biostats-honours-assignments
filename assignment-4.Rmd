...
- Using the `readr` package, read data from the following file: analgesic.csv (url: https://www.dropbox.com/s/boc4m4gpb9vkhgj/analgesic.csv?dl=1) into a dataframe object called 'df'.  
